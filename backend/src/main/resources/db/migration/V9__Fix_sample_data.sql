-- Migration V9 : Correction des données d'exemple et ajout de données de test

-- Supprimer les données existantes qui peuvent causer des erreurs
DELETE FROM articles;
DELETE FROM categories;
DELETE FROM users;

-- Utilisateurs avec tous les rôles (mots de passe : 'password')
INSERT INTO users (id, username, email, password, role, active, first_name, last_name, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'admin', 'admin@newsplatform.com', '$2a$10$N.EMYB7u2SFTgLOlp5QeduGHxjJ3T6Pk4TCdz.ZOyQmSvY9M9V.SW', 'ADMINISTRATEUR', true, 'Alice', 'Admin', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000002', 'editeur', 'editeur@newsplatform.com', '$2a$10$N.EMYB7u2SFTgLOlp5QeduGHxjJ3T6Pk4TCdz.ZOyQmSvY9M9V.SW', 'EDITEUR', true, 'Bob', 'Editeur', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000003', 'visiteur', 'visiteur@newsplatform.com', '$2a$10$N.EMYB7u2SFTgLOlp5QeduGHxjJ3T6Pk4TCdz.ZOyQmSvY9M9V.SW', 'VISITEUR', true, 'Charlie', 'Visiteur', NOW(), NOW());
...
INSERT INTO articles (id, title, slug, content, summary, author_id, category_id, status, published_at, created_at, updated_at) VALUES
  ...
  ('20000000-0000-0000-0000-000000000002', 'Match de football exceptionnel', 'match-football-exceptionnel', 'Retour sur un match de football absolument passionnant qui s''est déroulé hier soir dans des conditions exceptionnelles. Les joueurs ont montré un niveau de jeu remarquable.', 'Un match inoubliable', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000004', 'PUBLISHED', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '2 hours', NOW()),
  ('20000000-0000-0000-0000-000000000003', 'Article en brouillon', 'article-brouillon', 'Cet article est encore en cours de rédaction et n''est pas encore publié. Il sera disponible prochainement.', 'Article en cours', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', 'DRAFT', NULL, NOW() - INTERVAL '1 hour', NOW()),
  ('20000000-0000-0000-0000-000000000004', 'Nouvelles tendances en développement web', 'nouvelles-tendances-dev-web', 'Exploration des dernières tendances en développement web, frameworks et outils modernes qui transforment l''industrie du développement.', 'Tendances web modernes', '00000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000005', 'PUBLISHED', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '1 hour', NOW()),
  ('20000000-0000-0000-0000-000000000005', 'Innovation technologique de 2025', 'innovation-tech-2025', 'Les innovations technologiques qui marquent cette année et qui transforment notre quotidien. Des avancées majeures dans plusieurs domaines.', 'Tech 2025', '00000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'PUBLISHED', NOW() - INTERVAL '15 minutes', NOW() - INTERVAL '45 minutes', NOW()); 